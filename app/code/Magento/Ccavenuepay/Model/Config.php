...
class Config extends AbstractConfig
{
    ...
    public function getPaymentMarkImageUrl($localeCode, $orderTotal = null, $pal = null, $staticSize = null)
    {
        ...
        return sprintf(
            'https://www.ccavenuepayobjects.com/webstatic/en_US/i/buttons/pp-acceptance-%s.png',
            $staticSize
        );
    }
    ...
    {
        return sprintf(
            'https://www.ccavenuepay.com/%s/i/bnr/%s_solution_PP%s.gif',
    ...
    protected function _getDynamicImageUrl($type, $localeCode, $orderTotal, $pal)
    {
        ...
        return sprintf(
            'https://fpdbs%s.ccavenuepay.com/dynamicimageweb?%s',
