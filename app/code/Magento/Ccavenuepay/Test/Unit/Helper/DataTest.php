<?php
    /*
     ...
     Copyright         : © 2009-2017
     */
namespace Magento\Ccavenuepay\Test\Unit\Helper;
...
class DataTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->dataHelper = $helper->getObject(
            'Magento\Ccavenuepay\Helper\Data',
    ...
    public function getMessagesParamDataProvider()
    {
        ...
        return [
            [
                ...
                . 'Ccavenuepay Transaction ID ' . self::TRID . '. Addition message.',
            ],
            [
                'AUTH_CAPTURE',
                $amount,
                ...
                . 'Ccavenuepay Transaction ID ' . self::TRID . '. some exception'
            ],
            [
                'CREDIT',
                false,
    ...
    public function testGetRelayUrl()
    {
        ...
        $this->assertSame(
            'http://base.url/ccavenuepay/ccavenuepay/redirect',
